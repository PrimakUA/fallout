...
<article>
    ...
    <form action="form.php" method="post">
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-field-text" name="first_name" value="<?php echo $first_name; ?>" placeholder="Введите имя персонажа">
            <?php
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-field-text" name="last_name" value="<?php echo $last_name; ?>" placeholder="Введите фамилию персонажа">
            <?php
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-field-text" name="age" value="<?php echo $age; ?>" placeholder="Введите возраст персонажа">
            <?php
            if(isset($errors['age']))
            {
